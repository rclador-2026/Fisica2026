...
URL_SHEETS = "https://script.google.com/macros/s/AKfycbxwrJztRIbVseBYV8d3WjNPdFvnMpRyCE7Ghr_OpR69-AzYGfbJCh7BOzhTpsa198c2/exec"
...
def gemini_tutor(prompt: str, grupo: str, nivel: str, historial: list) -> str:
    ...
    if contexto:
        ...
        contents = f"{instrucciones}\n\nPregunta: {prompt}"
    try:
        response = client.models.generate_content(model="gemini-3.1-flash", contents=contents)
